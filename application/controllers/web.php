...
/*********************************************************************************************/
	function dosen(){
		...
		$data['page_title'] = 'Data Dosen JTI';		
...
/*********************************************************************************************/
	...
	function matakuliah(){
		...
		$data['page_title'] = 'Data Mata Kuliah JTI';		
	...
	function matakuliah_add(){
		...
		$data['page_title'] = 'Tambah Mata Kuliah';	
	...
	function matakuliah_edit($kode){
		...
		$data['page_title'] = 'Edit Mata Kuliah';	
...
/*************************************************************************************************/	
	...
	function jam_add(){
		...
		$data['page_title'] = 'Tambah Range Jam Kuliah';	
	...
	function jam_edit($kode){
		...
		$data['page_title'] = 'Edit Range Jam Kuliah';
...
/**************************************************************************************************/
	...
	function hari(){
		...
		$data['page_title'] = 'Data Hari Kuliah';		
	...
	function hari_add(){
		...
		$data['page_title'] = 'Tambah Hari Kuliah';	
	...
	function hari_edit($kode){
		...
		$data['page_title'] = 'Edit Hari Kuliah';
...
/**************************************************************************/
	function pengampu($semester_tipe = null,$tahun_akademik = null){
		...
		*/
		...
		$data['page_title'] = 'Data Pengampu Mata Kuliah JTI';		
	...
	function pengampu_add(){
		...
		$data['page_title'] = 'Tambah Pengampu Mata Kuliah JTI';
	...
	function pengampu_edit($kode){
		...
		$data['page_title'] = 'Edit Pengampu Mata Kuliah JTI';
