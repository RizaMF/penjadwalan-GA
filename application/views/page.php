...
<html lang="en">
   <head>
      <meta charset="utf-8" />
      <title>Penjadwalan Mata Kuliah JTI- <?php echo $page_title;?></title>
	  ...
	  <link href="<?php echo base_url().'assets/dist/img/logo.png' ?>" rel="shortcut icon" type="image/ico" />
      ...
      <body class="ie ie7 ">
         ...
         <body class="ie ie8 ">
            ...
            <body class="ie ie9 ">
               <![endif]-->
               <!--[if (gt IE 9)|!(IE)]><!--> 
               <body class="apple-touch-icon-precomposed">
                  <!--<![endif]-->
                  <div class="navbar">
                     <div class="navbar-inner">
                     </div>
                  </div>
                  <div class="sidebar-nav" style="padding-top: 6px">
                     <a href="<?php echo base_url();?>web" class="nav-header" ><i class="icon-dashboard"></i><b> Dashboard</b></a>
                     <a class="nav-header" data-target=".dashboard-menu" data-toggle="collapse" ><i class="icon-book"></i><b> Data-Data </b></i></a>
                     <ul class="dashboard-menu nav nav-list collapse in">                        
						...
						<li><a href="<?php echo base_url();?>web/pengampu"><i class="icon-group"></i> Pengampu Mata Kuliah</a></li>
						<li><a href="<?php echo base_url()?>web/ruang"><i class="icon-home"></i> Ruangan</a></li>
						<li><a href="<?php echo base_url()?>web/jam"><i class="icon-time"></i> Jam Kuliah</a></li>
						<li><a href="<?php echo base_url()?>web/hari"><i class="icon-calendar"></i> Hari Kuliah</a></li>
						<li><a href="<?php echo base_url()?>web/waktu_tidak_bersedia"><i class="icon-ban-circle"></i> Waktu Tidak Bersedia</a></li>
                     </ul>

					 <a class="nav-header" data-target=".proses-menu" data-toggle="collapse"><i class="icon-refresh"></i><b> Proses </b></a>
                     <ul class="proses-menu nav nav-list collapse in">                        
						<li><a href="<?php echo base_url();?>web/penjadwalan"><i class="icon-th-list"></i> Penjadwalan</a></li>
						<li><a href="<?php echo base_url();?>Adminweb"><i class="icon-ban-circle"></i> Logout</a></li>
					 </ul>	
                  </div>
