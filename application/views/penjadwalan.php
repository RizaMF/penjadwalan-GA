      ...
      <div class="row-fluid">
        ...
        <form class="form" method="POST" action="">
          ...
          <div class="block span6">
            ...
            <input type="text" name="jumlah_generasi" value="<?php echo isset($jumlah_generasi) ? $jumlah_generasi : '1000' ;?>">
          </div>
          <div class="form">
            <button type="submit" class=" btn btn-primary pull-left" onclick="ShowProgressAnimation();">Proses</button>
		...
		<div id="loading-div-background">
		  <div id="loading-div" class="ui-corner-all">
			<img style="height:50px;width:50px;margin:30px;" src="<?php echo base_url()?>assets/img/please_wait.gif" alt="Loading.."/><br>Sedang Memproses<br>Tunggu Beberapa Menit
		  </div>
		</div>
